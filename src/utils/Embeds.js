...
module.exports.HelpEmbed = new EmbedBuilder()
    ...
    .addFields({ name: "/undo [sets]", value: "Use this command to undo the last logged set, or [sets], if you made a mistake.\n- After the day ends everything is final, you cannot go back and undo a previous day's sets." })
    .addFields({ name: "/repeat [sets]", value: "Use this command to repeat the last logged set, or [sets]." })

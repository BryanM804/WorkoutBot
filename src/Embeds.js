...
module.exports.HelpEmbed = new EmbedBuilder()
    ...
    .addFields({ name: "/profile [user]", value: "Use this command to view information about your profile such as your level, current xp, days skipped, skip streak, and programmed rest days. Adding a [user] allows you to view someone elses profile."})

...
module.exports = (client, interaction) => {
    if(interaction.isAutocomplete() && (interaction.commandName === "log" || interaction.commandName === "stats" || interaction.commandName === "findlast" || interaction.commandName === "graph")){
